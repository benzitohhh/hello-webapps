...
displayLoginForm = () ->
  ...
  loginForm.append $("<input>").attr("id", "emailAddress").attr("name", "emailAddress").val("ben.immanuel@aistemos.com")
  loginForm.append $("<input>").attr("id", "password").attr("name", "password").attr("type", "password").val("ben")
